package  ge.ftsu.tsudokujavafx.userinterface;

import  ge.ftsu.tsudokujavafx.constants.GameState;
import  ge.ftsu.tsudokujavafx.auxiliaries.Coordinates;
...
public class UserInterfaceImpl implements IUserInterfaceContract.View,
    ...
    private static final Color WINDOW_BACKGROUND_COLOR = Color.rgb(17, 103, 189);
    private static final Color BOARD_BACKGROUND_COLOR = Color.rgb(224, 242, 241);
    private static final String SUDOKU = "TSUdoku";
