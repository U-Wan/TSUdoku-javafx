...
import ge.ftsu.tsudokujavafx.constants.Rows;
import ge.ftsu.tsudokujavafx.auxiliaries.SudokuGame;
import java.util.*;
import static  ge.ftsu.tsudokujavafx.auxiliaries.SudokuGame.GRID_BOUNDARY;
public class GameLogic {
    ...
    //gadaecema grid-is saxit puzzli da abrunebs shvesebuli aris tu ara sworad
